...
vk.init(function() {
  var intro;
  vk.resize(1000);
  return intro = require('./intro/index.coffee');
});


},{"./intro/index.coffee":5,"./tools/vk.coffee":44}],5:[function(require,module,exports){
var parallaxModule, popups, preloadModule, prizes;

popups = require('../popups');

parallaxModule = require('./parallax');

preloadModule = require('./preload');

prizes = require('./prizes');

prizes.changeDays(7);

$('.intro__startbut').on("click", function() {
  return popups.openModal("intro");
});


},{"../popups":15,"./parallax":6,"./preload":7,"./prizes":8}],6:[function(require,module,exports){
var parallaxModule;

parallaxModule = (function() {
  var $background, $wrapper, parallax;
  $wrapper = $('.intro__wrapper');
  $background = $('.intro__back');
  $wrapper.on('mousemove', function(e) {
    var mousex, mousey;
    mousex = e.clientX - $wrapper.offset().left;
    mousey = e.clientY - $wrapper.offset().top;
    return parallax(mousex, mousey);
  });
  return parallax = function(mousex, mousey) {
    var APP_H, APP_W, BACK_H, BACK_W, back_x, back_y;
    BACK_W = 1100;
    BACK_H = 1100;
    APP_W = 1000;
    APP_H = 1000;
    back_x = mousex - mousex * BACK_W / APP_W;
    back_y = mousey - mousey * BACK_H / APP_H;
    return $background.css('transform', "translate(" + back_x + "px, " + back_y + "px)");
  };
})();
...
introPreload = (function() {
  ...
  $(window).on('load', function() {
    startAnimation($('.intro__back'));
    startAnimation($('.intro__right'));
    startAnimation($('.intro__gamelogo'));
    startAnimation($('.intro__start'));
    return startAnimation($('.intro__startbut'));
  });
  return startAnimation = function($el) {
    $el.css('animation-play-state', 'running');
    $el.css('-webkit-animation-play-state', 'running');
    return $el.css('-moz-animation-play-state', 'running');
  };
})();
...
module.exports = (function() {
  return {
    changeDays: function(val) {
      ...
      dig1 = Math.floor(val / 10);
      dig2 = val % 10;
      $('.intro__dayval1').html(dig1);
      return $('.intro__dayval2').html(dig2);
    }
  };
})();
...
},{"../request":40,"../tools/achvData.coffee":41,"../tools/vk.coffee":44,"./achieve.jade":10}],10:[function(require,module,exports){
var jade = require("jade/runtime");
...
},{"../../header/messenger__icon.jade":3,"../../request/index":40,"./messenger.jade":22,"./notification.jade":23,"./question.jade":24}],22:[function(require,module,exports){
var jade = require("jade/runtime");
...
},{"../tools/keys.coffee":42}],41:[function(require,module,exports){
module.exports = [
  {
    achievement_id: 10,
    num: 0,
...
},{"./md5.coffee":43}],43:[function(require,module,exports){
